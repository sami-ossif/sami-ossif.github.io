...
#classe pour le personnage de goku
class Goku(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.imageg = pygame.image.load('Image/Personnage/SonGokuV2.png').convert_alpha()
        self.imaged = pygame.image.load('Image/Personnage/SonGokuV2_1.png').convert_alpha()
        self.rect = self.imageg.get_rect()
        self.rect.x=0
        self.rect.y= 450
        self.direction = 1
